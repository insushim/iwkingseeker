...
const baseQuestions: QuestionSeed[] = [
  ...
  { grade: 5, subject: '수학', unit: '3. 규칙과 대응', unit_code: '[6수04-01]', question_type: 'multiple_choice', question_text: 'x가 1, 2, 3일 때 y가 3, 6, 9이면, x와 y의 관계는?', options: ['y = x × 3', 'y = x + 3', 'y = x × 2', 'y = x + 2'], correct_answer: 'y = x × 3', explanation: '1×3=3, 2×3=6, 3×3=9이므로 y = x × 3입니다.', difficulty: 2 },
